...
public void init() throws ServletException { }
	...
	public abstract void initProcess(HttpServletRequest request, HttpServletResponse reponse);
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException {
		...
		String viewPage=null; String tempMethod = null;
		try{
			for(Method method : methods) {
				...
				if(!tempMethod.equals("POST")) { tempMethod = "GET"; }
...
class RequestNotMatch extends Exception {
	RequestNotMatch(String name) { super(name); }}
